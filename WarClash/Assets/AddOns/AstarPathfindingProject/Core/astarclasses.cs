...
namespace Pathfinding {
	...
	public struct NNInfo {
	    ...
	    public static explicit operator Vector3d(NNInfo ob)
	    {
	        return ob.fixedClampedPosition;
	    }
	}
