...
public class DynamicTree<T>
{
    ...
    public long AreaRatio
    {
        get
        {
            ...
            long rootArea = root.AABB.Perimeter;
    ...
    private void InsertLeaf(int leaf)
    {
        ...
        while (_nodes[index].IsLeaf() == false)
        {
            ...
            else
            {
                AABB aabb = new AABB();
                aabb.Combine(ref leafAABB, ref _nodes[child1].AABB);
                long oldArea = _nodes[child1].AABB.Perimeter;
                long newArea = aabb.Perimeter;
            ...
            else
            {
                AABB aabb = new AABB();
                aabb.Combine(ref leafAABB, ref _nodes[child2].AABB);
                long oldArea = _nodes[child2].AABB.Perimeter;
                long newArea = aabb.Perimeter;
